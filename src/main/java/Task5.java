...
public class Task5 {
    public static void main(String[] args) {
        ...
        hashMapCountries.put(1, "Канада");
        hashMapCountries.put(2, "Германия");
        hashMapCountries.put(3, "Франция");
        ...
        hashMapCapitalCities.put(2, "Берлин");
        hashMapCapitalCities.put(6, "Вена");
        hashMapCapitalCities.put(8, "Каир");
        hashMapCapitalCities.put(3, "Париж");
